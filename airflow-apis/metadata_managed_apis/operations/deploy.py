...
from metadata_managed_apis.api.utils import (
    clean_dag_id,
    get_dagbag,
    import_path,
...
class DagDeployer:
    ...
    def __init__(self, ingestion_pipeline: IngestionPipeline):
        ...
        SecretsManagerFactory(
            ingestion_pipeline.MetadataServerConnection.secretsManagerProvider,
            ingestion_pipeline.MetadataServerConnection.secretsManagerLoader,
        )
