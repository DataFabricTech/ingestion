...
from metadata_managed_apis.workflows.config import load_config_file
from metadata_managed_apis.workflows.workflow_builder import WorkflowBuilder
...
class WorkflowFactory:
    ...
    def __init__(self, airflow_pipeline: IngestionPipeline) -> None:
        ...
        SecretsManagerFactory(
            airflow_pipeline.metadataServerConnection.secretsManagerProvider,
            airflow_pipeline.metadataServerConnection.secretsManagerLoader,
        )
