...
from metadata.ingestion.server.mixins.lineage_mixin import OMetaLineageMixin
from metadata.ingestion.server.utils import format_name
...
class OMetaMlModelMixin(OMetaLineageMixin):
    """
    Metadata API methods related to MlModel.
    ...
    def get_mlmodel_sklearn(
        ...
        :return: Metadata CreateMlModelRequest Entity
        """
        try:
            ...
            logger.error(
                ...
                "pip install metadata-ingestion[sklearn], %s",
                err,
            )
            raise err
