...
from metadata.ingestion.server.client import REST, APIError
from metadata.ingestion.server.utils import get_entity_type
...
class OMetaLineageMixin(Generic[T]):
    """
    Metadata API methods related to Lineage.
