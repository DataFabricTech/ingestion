...
from metadata.ingestion.server.mixins.container_mixin import OMetaContainerMixin
from metadata.ingestion.server.mixins.custom_property_mixin import (
    OMetaCustomPropertyMixin,
)
from metadata.ingestion.server.mixins.dashboard_mixin import OMetaDashboardMixin
from metadata.ingestion.server.mixins.data_insight_mixin import DataInsightMixin
from metadata.ingestion.server.mixins.es_mixin import ESMixin
from metadata.ingestion.server.mixins.glossary_mixin import OMetaGlossaryMixin
from metadata.ingestion.server.mixins.ingestion_pipeline_mixin import (
    OMetaIngestionPipelineMixin,
)
from metadata.ingestion.server.mixins.mlmodel_mixin import OMetaMlModelMixin
from metadata.ingestion.server.mixins.patch_mixin import OMetaPatchMixin
from metadata.ingestion.server.mixins.pipeline_mixin import OMetaPipelineMixin
from metadata.ingestion.server.mixins.query_mixin import OMetaQueryMixin
from metadata.ingestion.server.mixins.role_policy_mixin import OMetaRolePolicyMixin
from metadata.ingestion.server.mixins.search_index_mixin import OMetaSearchIndexMixin
from metadata.ingestion.server.mixins.server_mixin import OMetaServerMixin
from metadata.ingestion.server.mixins.service_mixin import OMetaServiceMixin
from metadata.ingestion.server.mixins.suggestions_mixin import OMetaSuggestionsMixin
from metadata.ingestion.server.mixins.table_mixin import OMetaTableMixin
from metadata.ingestion.server.mixins.tests_mixin import OMetaTestsMixin
from metadata.ingestion.server.mixins.topic_mixin import OMetaTopicMixin
from metadata.ingestion.server.mixins.user_mixin import OMetaUserMixin
from metadata.ingestion.server.mixins.version_mixin import OMetaVersionMixin
from metadata.ingestion.server.models import EntityList
from metadata.ingestion.server.routes import ROUTES
from metadata.ingestion.server.utils import get_entity_type, model_str
...
class ServerInterface (
    ...
    client: REST
    _auth_provider: MetadataAuthenticationProvider
    config: MetadataConnection
    ...
    def __init__(
        ...
        self._auth_provider = MetadataAuthenticationProvider.create(self.config)
